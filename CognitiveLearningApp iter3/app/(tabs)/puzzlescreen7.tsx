...
export default function puz7() {
  ...
  const submit = () => {
    if (userAnswer.trim().toLowerCase() === correctanswer.toLowerCase()) {
      ...
      router.push({ pathname: "/puzzlescreen8", params: {time: time, puzzleScores: JSON.stringify(Puzzlescores), uid: uid, email: email, besttime: besttime, todaytime: todaytime, textsize: textsize }});
    } 
    else {
