...
export default function Settings() {
  ...
  let smallsel = "";
  let defaultsel = "";
  //highlight larger if its selected
  if(textsize=="Larger"){
    textsizenumber = 5;
    largesel = '#008521';
    defaultsel = '#393b42';
  ...
  //highlight smaller if its selected
  if(textsize=="Smaller"){
    textsizenumber = -5;
    smallsel = '#008521';
    largesel = '#393b42';
  ...
  //highlight default if its selected
  if(textsize=="Default"){
    textsizenumber = 0;
    defaultsel = '#008521';
    largesel = '#393b42';
  ...
  async function updatetextsmaller(uid: string) {
    ...
    //refresh page
    router.push({ pathname: "/settingsgrey", params: { uid: uid, email: email, besttime: besttime, todaytime: todaytime, textsize: textsize }})
  }
    ...
    <View style={styles.maincontainer}>
      {/* header section */}
        <View style={styles.subcontainer}>
            <TouchableOpacity onPress={() => router.push({ pathname: "/homegrey", params: { uid: uid, email: email, besttime: besttime, todaytime: todaytime, textsize: textsize }})}><Ionicons name="arrow-back-circle-outline" size={40} color="#ffffff" /></TouchableOpacity>
        ...
        <View style={styles.sub2container}>
            ...
            <TouchableOpacity style={styles.row}>
              <Text style={[styles.selected,{backgroundColor:smallsel}]} onPress={() => updatetextdefault(uid)}>Smaller</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.row}>
              <Text style={[styles.selected,{backgroundColor:defaultsel}]} onPress={() => updatetextdefault(uid)}>Default</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.row}>
              <Text style={[styles.selected,{backgroundColor:largesel}]} onPress={() => updatetextdefault(uid)}>Larger</Text>
            </TouchableOpacity>
        </View>
    </View>
  );
