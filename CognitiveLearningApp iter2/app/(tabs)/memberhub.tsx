  ...
  return (
    ...
    <View style={styles.maincontainer}>
        ...
        <View style={styles.sub2container}>
            <Text style={[styles.logotext,{marginBottom:20,color:"#3a4c87",fontSize: 26+textsizenumber}]}>View Statistics</Text>
            <Text style={[styles.logotext,{marginBottom:30}]}>wwww</Text>
        </View>
        {/*lower section, holds setting and log out navigations*/}
        <View style={styles.sub3container}>
            <TouchableOpacity onPress={() => router.push({ pathname: "/settingsgrey", params: { uid: uid, email: email, textsize: textsize }})}>
