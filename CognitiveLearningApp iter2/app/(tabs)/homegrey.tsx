  ...
  return (
    ...
    <View style={styles.maincontainer}>
        ...
        <View style={styles.sub2container}>
            ...
            <Text style={[styles.logotext,{marginBottom:30}]}>Start Puzzle Track</Text>
            {/*starts puzzle track*/}
            <TouchableOpacity onPress={() => alert("Puzzle Track Resets Tomorrow.")} style={styles.playbutton}><Text style={styles.buttont}>Begin</Text></TouchableOpacity>
        </View>
        {/*lower section, holds setting and log out navigations*/}
        <View style={styles.sub3container}>
            <TouchableOpacity onPress={() => router.push({ pathname: "/settingsgrey", params: { uid: uid, email: email, besttime: besttime, todaytime: todaytime, textsize: textsize }})}>
